...
local define_boat = function()
  ...
  local REGEXP = {
    ONBOARD = "^[ >]*(艄公把踏脚板收起来.*|船夫把踏脚板收起来.*|小舟在湖中藕菱之间的水路.*|你跃上小舟，船就划了起来。.*|你拿起船桨用力划了起来。.*|番僧用力一推，将藤筐推离平台，绞盘跟着慢慢放松，藤筐一荡，降了下去。|绳索一紧，藤筐左右摇晃振动了几下，冉冉向上升了起来。)$",
    BLOCKED_BY_BOATMAN = "^[ >]*艄公一把拉住你，.*",
    BOAT_ARRIVED = "^[> ]*(艄公说“到啦，上岸吧”.*|船夫对你说道：“到了.*|你朝船夫挥了挥手.*|小舟终于划到近岸.*|.*你跨上岸去。.*|不知过了多久，船终于靠岸了，你累得满头大汗。.*|一个番僧用沙哑的声音道：“大轮寺到啦，出来吧。”，.*|藤筐离地面越来越近，终于腾的一声着了地，众人都吁了口长气.*)$",
    -- BOAT_ARRIVED = "^[ >]*(你终于来到了对面，心里的石头终于落地.*|突然间蓬一声，屁股撞上了什么物事，.*|你终于一步步的终于挨到了桥头.*)$",
    BOAT_COMING = "^[ >]*(一叶扁舟缓缓地驶了过来，艄公将一块踏脚板.*|岸边一只渡船上的老艄公说道：正等着你.*|番僧点了点头道：正好，筐正要放下去，你快进去吧。|番僧把麻绳理顺，将藤筐扶稳后边道：好啦，上去吧。|喊了半天没动静，你这才发现眼前就有一个老大的藤筐。|一条粗大的绳索坠着个大藤筐自云雾中缓缓垂落下来，轻轻落在地上。)$",
  }
